...
if ( !function_exists( 'bp_core_install' ) ) {
	...
	if ( is_plugin_active( 'buddypress/bp-loader.php' ) ) {
		...
		add_action( 'admin_notices', 'bphelp_my_activity_privacy_component_install_buddypress_notice' );
		return;
	}
}


function bphelp_my_activity_privacy_component_install_buddypress_notice() {
	echo '<div id="message" class="error fade"><p style="line-height: 150%">';
	_e('<strong>Activity Privacy Component</strong></a> requires the BuddyPress plugin to work. Please <a href="http://buddypress.org/download">install BuddyPress</a> first, or <a href="plugins.php">deactivate Activity Privacy Component</a>.');
	echo '</p></div>';
}
/* Stop errors if any */
